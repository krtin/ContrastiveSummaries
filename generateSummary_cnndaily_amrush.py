...
smc_data = pd.read_csv('data/smc_rush_final.csv', dtype={'idx': np.int64, 'smc': object, 'smc_prob': np.float64}, usecols=['idx', 'smc', 'smc_prob'])
...
smic_data = pd.read_csv('data/smic_rush_final.csv', dtype={'ruleid': np.int32, 'smic': object, 'sourceid': np.int64, 'smic_prob': np.float64})
